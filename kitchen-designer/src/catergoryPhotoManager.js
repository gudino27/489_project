...
const CategoryPhotoManager = () => {
  ...
  const handlePhotoUpload = async (e) => {
    ...
    try {
      ...
      for (let file of files) {
        ...
        formData.append('category', selectedCategory); // Make sure this is set
        
        console.log('Uploading to category:', selectedCategory); // Debug log
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold mb-6">Portfolio Photo Manager</h2>
